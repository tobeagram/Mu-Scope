...
<head>
    ...
    #portfolio .portfolio-item .portfolio-link .caption:hover .caption-content i {
        background: #F23B3E;
        /*border: 1px rgba(41, 40, 36, 0.8) solid;*/
        color: #fbf8f2;
        ...
        <div class="container">
            ...
            <div style="border:none;" class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a style="color:rgba(0, 0, 0, 0.7);" href="#">exhibitions</a>
                    </li>
                    <li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 style="color:#F23B3E">Exhibitions</h2>
                        ...
                        <a href="#<?php echo $collection_name; ?>portfolio" class="portfolio-link" data-toggle="modal">
                            <div class="caption">
                                <div class="caption-content">
                                    <i>A Dozen <?php echo $collection_name; ?></i>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="modal-body" style="padding: 0 0 0 0;">
                                        ...
                                        <!-- Page Heading -->
                                                ...
                                                <h1 class="page-header" style="color:#F8F8F8;">A Dozen <?php echo ucwords($collection_name); ?><br>
                                                        ...
                                                        ?>
                                                            <a href="<?php echo $url; ?>" id="polaroid">
                                                                ...
                                                                <div class="text-right" style="padding: 0 7px 7px 7px;letter-spacing: 2px; color:rgba(0, 0, 0, 0.2);">
                                                                    &nbsp;<i class="<?php echo $stl_icon; ?>" title="This specimen has a 3D model"></i>
                                                                    <i class="<?php echo $dicom_icon; ?>" title="This specimen has a CT Scan"></i>
                                                                </div>
                                                                <?php
                ...
                <footer>
                    ...
                    <div class="col-lg-12 text-center">
                      ...
                      <span class="intbut" data-dismiss="modal" style=" display:inline; padding-bottom: 30px;"><a href="#a1" id="afterarrow" style="font-size:18px;" class="btnl page-scroll"><f class="fa fa-times-circle"></f> <span id="beforearrow">close&nbsp;</span></a></span>
                        ...
                        <div class="row">
                          <hr><br>
                              <a href="../acknowledgements" style="text-decoration:none;"><p class="large-footer" style="color:#F8F8F8">Copyright &copy; 2016 Rashed Karim, Kawal Rhode and Tobias Whetton. All Rights Reserved.</p></a>
                        </div>
                    </div>
                    <!-- /.row -->
                </footer>
